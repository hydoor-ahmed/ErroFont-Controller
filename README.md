...
Installation 📦
Install a UserScript Manager: Install Tampermonkey or Violentmonkey on your browser (e.g., Brave, Chrome, Firefox).
...
Enjoy: Refresh any website to see the changes.
